%% Zirmi Package - (C) Computing Cell Migration based Metrics
% Updated 11/17/2017
...
disp('WARNING: Need to have handles.distmap and accurate spatial domains 1 & 2')%Spatial Domain 1 is Wound GAP Spaital domain 2 is Tip of notochord
disp('WARNING: If Removing Movement remember to save NEW handles')
pause(2);
...
for i=1:Num_TrackMax
    ...
    d=handles.distanceNetwork.perHop(:,i); %abs Distance per Hop
    a(a==0)=[];
