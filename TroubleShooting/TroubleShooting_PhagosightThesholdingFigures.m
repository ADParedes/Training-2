...
%     h111=figure(111);
%     cla
%     p1 = patch(isosurface(dataR(indexR,indexC,indexL), handles.thresLevel(1)),'FaceColor','b','EdgeColor','none');
%     p2 = patch(isosurface(dataR(indexR,indexC,indexL), handles.thresLevel(2)),'FaceColor','r','EdgeColor','none');
%         axis ij
%     view(10,70)
%     alpha (0.5)
%     q1=camlight('right');
